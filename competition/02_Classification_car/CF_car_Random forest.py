...
def run_main():
    ...
    Evaluation_pred = clf.predict_proba(train_test_pred)[:, 1]
    # print('Evaluation_test: \n',Evaluation_test)
    # print(clf.score( train_test_pred, Evaluation_test))

    print('未通过审核的概率 :', average_precision_score( Evaluation_test, Evaluation_pred))
    print(roc_auc_score(train_test_pred, Evaluation_pred))
